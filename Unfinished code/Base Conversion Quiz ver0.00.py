...
def Make_Easy(): # This makes the easy difficulty
    ...
    sw.pack(anchor=NE)
    Button(easy_window, text='Reset', command=sw.Reset).pack(side=RIGHT)
    Button(easy_window, text="Stop", command=easy_window.destroy).pack(side=RIGHT)
    Button(easy_window, text='Start', command=sw.Start).pack(side=RIGHT)
    sw.MakeLabel()
    sw.Start()
...
def Make_Medium(): # This makes the medium difficulty
    ...
    sw.pack(anchor=NE)
    Button(medium_window, text='Reset', command=sw.Reset).pack(side=RIGHT)
    Button(medium_window, text="Stop", command=medium_window.destroy).pack(side=RIGHT)
    Button(medium_window, text='Start', command=sw.Start).pack(side=RIGHT)
    sw.MakeLabel()
    sw.Start()
...
def Make_Hard(): # This makes the hard difficulty
    ...
    sw.pack(anchor=NE)
    Button(hard_window, text='Reset', command=sw.Reset).pack(side=RIGHT)
    Button(hard_window, text="Stop", command=hard_window.destroy).pack(side=RIGHT)
    Button(hard_window, text='Start', command=sw.Start).pack(side=RIGHT)
    sw.MakeLabel()
    sw.Start()
