...
def Make_Expert(): # This makes the expert difficulty
    ...
    global answer, points, expert_result_label, expert_window, load_question, question_no
    ...
    def load_question():
        ...
        if this_to == 1: # Binary to
            ...
            if this == 1: # Binary
                ...
                octal_int = int(octal)
                answer = binary_int
                expert_question_label.config(text="What is "+str(binary_int)+" (Octal) in Binary")
            elif this == 2: # Decimal
                random = rand(1,100)
                decimal_int = int(random)                
                divider = random
