...
global timer_toggle, easy_window_bg, medium_window_bg, expert_window_bg, points, answer, hex_digits
timer_toggle = True
    ...
    def load_question():
        ...
        if this_to == 1: # Binary to
            ...
            if this == 1: # Decimal
                ...
                answer = decimal_int
                easy_question_label.config(text="What is "+str(binary_int)+" (Binary) in Decimal")
            ...
            if this == 1: # Binary
                ...
                binary_int = int(binary)
                answer = binary_int
                easy_question_label.config(text="What is "+str(decimal_int)+" (Decimal) in Binary")
            elif this == 2: # Octal (cant be called on easy)
                error("outside_val")
            elif this == 3: # Hex (cant be called on easy)
                error("outside_val")
...
def Make_Medium(): # This makes the medium difficulty
    ...
    global answer, points, medium_result_label, medium_window, load_question, question_no, medium_user_entry
    ...
    medium_submit_button.config(bg="#d7caa4")
    ...
    def load_question():
        ...
        if this_to == 1: # Binary to
            ...
            if this == 1: # Decimal
                ...
                octal_int = int(octal)
                answer = octal_int
                medium_question_label.config(text="What is "+str(binary_int)+" (Binary) in Octal")
...
def Make_Expert(): # This makes the expert difficulty
    ...
    global answer, points, expert_result_label, expert_window, load_question, question_no, hex_digits, expert_user_entry
    ...
    expert_submit_button.config(bg="#ca8c8c")
    ...
    def load_question():
        ...
        if this_to == 1: # Binary to
            ...
            if this == 1: # Decimal
                ...
                binary_int = int(binary)
                answer = decimal_int
                expert_question_label.config(text="What is "+str(binary_int)+" (Binary) in Decimal")
            elif this == 2: # Octal
                random = rand(1,100)
                devider = random
                binary = ""
                ...
                octal_int = int(octal)
                answer = octal_int
                expert_question_label.config(text="What is "+str(binary_int)+" (Binary) in Octal")
            elif this == 3: # Hex
                random = rand(1,100)
                devider = random
                binary = ""
                ...
                while divider > 0:
                    ...
                    divider = divider // 16
                answer = hex_str
                expert_question_label.config(text="What is "+str(binary_int)+" (binary) in Hex")
            else:
                error("outside_val")
        elif this_to == 2: # Decimal to
            this = int(rand(1,1))
            if this == 1: # Binary
                ...
                binary_int = int(binary)
                answer = binary_int
                expert_question_label.config(text="What is "+str(decimal_int)+" (Decimal) in Binary")
            elif this == 2: # Octal
                random = rand(1,100)
                decimal_int = int(random)
                divider = random
                ...
                octal_int = int(octal)
                answer = octal_int
                expert_question_label.config(text="What is "+str(decimal_int)+" (Decimal) in Octal")
            elif this == 3: # Hex
                random = rand(1,100)
                decimal_int = int(random)
                divider = random
                ...
                while divider > 0:
                    ...
                    divider = divider // 16
                answer = hex_str
                expert_question_label.config(text="What is "+str(decimal_int)+" (Decimal) in Hex")
            else:
                error("outside_val")
        elif this_to == 3: # Octal to
            this = int(rand(1,3))
            if this == 1: # Binary
                ...
                octal_int = int(octal)
                answer = binary_int
                expert_question_label.config(text="What is "+str(octal_int)+" (Octal) in Binary")
            elif this == 2: # Decimal
                random = rand(1,100)
                decimal_int = int(random)                
                divider = random
                ...
                octal_int = int(octal)
                answer = decimal_int
                expert_question_label.config(text="What is "+str(octal_int)+" (Octal) in Decimal")
            elif this == 3: # Hex
                random = rand(1,100)
                divider = random
                octal = ""
                ...
                while divider > 0:
                    ...
                    divider = divider // 16
                answer = hex_str
                expert_question_label.config(text="What is "+str(octal_int)+" (Octal) in Hex")
            else:
                error("outside_val")
            ...
            if this == 1: # Binary
                ...
                while divider > 0:
                    ...
                    divider = divider // 16
                answer = binary_int
                expert_question_label.config(text="What is "+str(hex_str)+" (Hex) in binary")
            elif this == 2: # Decimal
                random = rand(1,100)
                decimal_int = int(random)
                divider = random
                ...
                while divider > 0:
                    ...
                    divider = divider // 16
                answer = decimal_int
                expert_question_label.config(text="What is "+str(hex_str)+" (Hex) in Decimal")
            elif this == 3: # Octal
                random = rand(1,100)
                divider = random
                octal = ""
                ...
                while divider > 0:
                    ...
                    divider = divider // 16
                answer = octal_int
                expert_question_label.config(text="What is "+str(hex_str)+" (Hex) in Octal")
            else:
                error("outside_val")
        else:
            error("outside_val")
