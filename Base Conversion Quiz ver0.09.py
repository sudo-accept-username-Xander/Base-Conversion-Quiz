...
global timer_toggle, easy_window_bg, medium_window_bg, expert_window_bg
timer_toggle = True
...
def main(): # Root window setup makes the user choose a difficulty and welcomes the user
    ...
    frame = Frame(root, width=650,height=80, bg="#FFFFFF").grid(row=3, column=0, columnspan=5)
    ...
    quit_var = Button(frame1, text="Quit", command=root.destroy, width=10).grid(padx=4, pady=8, row=5, column=2) # Exit
